...
Inclua instruções ou script mostrando:
...
Este é um desafio que reflete problemas reais enfrentados em produção. **O objetivo não é cumprir com 100% do desafio**, principalmente os extras. Priorize:
